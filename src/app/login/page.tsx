    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <p className="text-gray-600 text-center mb-6">
          Sign in with your Google account to access the Truck Wash App
        </p>
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-3 py-3 px-4 rounded border transition-colors ${
            isLoading
